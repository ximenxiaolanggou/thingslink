...
public class RedisService {
     ...
     * 获取所有keys
     */
    public Set<String> allKeys(String keyReg) {

        Set<String> keys = (Set<String>) redisTemplate.execute((RedisCallback<Set<String>>) connection -> {
            Set<String> keysTmp = new HashSet<>();
            ScanOptions.ScanOptionsBuilder builder = ScanOptions.scanOptions().count(1000);
            if(keyReg != null && keyReg.trim() != "")
                builder.match(keyReg);
