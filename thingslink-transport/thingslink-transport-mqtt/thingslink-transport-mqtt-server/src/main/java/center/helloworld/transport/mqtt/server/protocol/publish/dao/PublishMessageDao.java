package center.helloworld.transport.mqtt.server.protocol.publish.dao;
 ...
 * @author zhishun.cai
 * @create 2023/8/2
 * @note PUBLISH 消息存储实现类
 */

@Component
public class PublishMessageDao extends MessageStore {

    private String CACH_PREFIX = "thingslink_pub_msg_";

    @Autowired
    public PublishMessageDao(IStorageMode messageStorageMode) {
