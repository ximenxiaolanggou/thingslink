package center.helloworld.transport.mqtt.server.protocol.pubrel.store;
...
@Component
public class PubRelMessageStore extends MessageStore {

    private String CACH_PREFIX = "thingslink_rel_msg_";

    @Autowired
    public PubRelMessageStore(IStorageMode messageStorageMode) {
